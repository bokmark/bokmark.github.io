...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bc914417d789030be7fec39d47d93b54f51874f361201559472cd654a3f9efa9.js',function(){input.required=false;search();});}
