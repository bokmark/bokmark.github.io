...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f922e0f395ee684999ffb50f71a38ae02bfcc517a5f85a4dcf72a4012c0dd778.js',function(){input.required=false;search();});}
