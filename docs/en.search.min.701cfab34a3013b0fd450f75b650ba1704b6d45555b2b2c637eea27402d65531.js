...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d7947a5e220d7c53f68b0a525265300da9121ded205bcef8c761d13d4958fbea.js',function(){input.required=false;search();});}
