...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6bef0ba35a1b71dc5754afe2f0ecb5161b9adeae2c13903796860a55ba584a5d.js',function(){input.required=false;search();});}
